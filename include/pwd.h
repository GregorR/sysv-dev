...
#if !defined(__XOPEN_OR_POSIX) || defined(__EXTENSIONS__)
extern struct passwd *_abi_fgetpwent(FILE *);	/* MT-unsafe */
...
extern void _abi_endpwent(void);
extern struct passwd *_abi_getpwent(void);		/* MT-unsafe */
extern void _abi_setpwent(void);
...
#if !defined(__XOPEN_OR_POSIX) || defined(__EXTENSIONS__)
extern struct passwd *_abi_fgetpwent();		/* MT-unsafe */
#define fgetpwent _abi_fgetpwent
extern int putpwent();
#endif /* !defined(__XOPEN_OR_POSIX) || defined(__EXTENSIONS__) */
...
#if !defined(__XOPEN_OR_POSIX) || defined(_XPG4_2) || \
	defined(__EXTENSIONS__)
extern void _abi_endpwent();
extern struct passwd *_abi_getpwent();		/* MT-unsafe */
extern void _abi_setpwent();
#define endpwent _abi_endpwent
#define getpwent _abi_getpwent
#define setpwent _abi_setpwent
#endif /* !defined(__XOPEN_OR_POSIX) || defined(_XPG4_2) ... */
