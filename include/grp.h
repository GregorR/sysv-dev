...
#if defined(__EXTENSIONS__) || !defined(__XOPEN_OR_POSIX)
extern struct group *_abi_fgetgrent(FILE *);		/* MT-unsafe */
...
extern void _abi_endgrent(void);
extern void _abi_setgrent(void);
extern struct group *_abi_getgrent(void);		/* MT-unsafe */
...
#if defined(__EXTENSIONS__) || !defined(__XOPEN_OR_POSIX)
extern struct group *_abi_fgetgrent();		/* MT-unsafe */
#define fgetgrent _abi_fgetgrent
extern int initgroups();
#endif /* defined(__EXTENSIONS__) || !defined(__XOPEN_OR_POSIX) */

#if defined(__EXTENSIONS__) || !defined(__XOPEN_OR_POSIX) || defined(_XPG4_2)
extern void _abi_endgrent();
extern void _abi_setgrent();
extern struct group *_abi_getgrent();		/* MT-unsafe */
#define endgrent _abi_endgrent
#define setgrent _abi_setgrent
#define getgrent _abi_getgrent
#endif /* defined(__EXTENSIONS__) || !defined(__XOPEN_OR_POSIX)... */
